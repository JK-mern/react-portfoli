    ...
    <div className="max-w-6xl mx-auto" id="Contact">
      <div>
        ...
        <div className="flex flex-col my-12">
          ...
          {copied && <p className="hidden md:inline-block  md:top-[40%] right-[30%]  md:right-[44%] text-center">Copied!!</p>}
          <div className="flex  gap-4  justify-center items-center text-center mt-10 mx-6  ">
            <a href="http://">
              <button className="p-3   bg-sky-900  hover:bg-sky-600  text-white  rounded-xl ">
                <FontAwesomeIcon
                  icon={faLinkedin}
                  style={{ color: "#ffffff" }}
                  size="xl"
                  className="rounded-xl mb-1 md:mb-0"
